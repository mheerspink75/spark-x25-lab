...
- **Affected files:** `test_prompts/memory_stress_test/requirements.txt`, `local_web_dashboard/requirements.txt`, `github_issue_triage/requirements.txt`, `opencode.json`.
...
- **Affected files:** `github_issue_triage/main.py`, `compliance_test/csv_reader.py`, `compliance_test/csv_parser.py`, `compliance_test/csv_processor.py`, `compliance_test/csv_validator.py`, `compliance_test/csv_reporter.py`, `local_web_dashboard/dashboard.py`.
...
- **Affected files:** `local_web_dashboard/dashboard.py`, `local_web_dashboard/requirements.txt` (if using `flask-http-auth` or similar).
...
- **Affected files:** `local_web_dashboard/dashboard.py`, `run.sh`, system firewall rules (outside workspace).
...
- **Affected files:** All Python modules (`compliance_test/*`, `github_issue_triage/*`, `local_web_dashboard/dashboard.py`, `test_prompts/memory_stress_test/benchmark.py`).
...
- **Affected files:** `github_issue_triage/tests/`, `github_issue_triage/main.py`, `github_issue_triage/src/issue_triage/*`.
...
- **Affected files:** `.gitignore`, `github_issue_triage/REPORT.md`, `github_issue_triage/charts/`, `test_prompts/memory_stress_test/REPORT.md`, `test_prompts/memory_stress_test/.benchmark_results/`.
...
- **Affected files:** `test_prompts/memory_stress_test/benchmark.py`, `test_prompts/memory_stress_test/REPORT.md`, `local_web_dashboard/dashboard.py`.
